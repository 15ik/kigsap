    ...
    CASE ME->M_NAME.
      WHEN 'ALV_GRID'.
        CASE E_UCOMM.
          WHEN 'OK_CODE'.
          WHEN 'BTN_ON_PRINT'.
*            PERFORM BTN_ON_PRINT_PDF.  "출력  U3 PDF
*          WHEN 'BTN_ON_ZFDLV'.
*            PERFORM BTN_ON_ZFDLV_INIT.  "배치 조회
*          WHEN 'BTN_OFF_ZFDLV'.
*            PERFORM BTN_OFF_ZFDLV_INIT.
          WHEN OTHERS.
...
*===============================================================================================
  METHOD ON_SAVE_VARIANT.
    ...
    CASE IV_NAME.
      WHEN 'ALV_GRID' OR 'ALV_GIRD_0200'.
        CV_DEFAULT = 'X'.
        CV_SAVE    = 'A'.
      WHEN OTHERS.
    ENDCASE.
...
*--------------------------
      ...
      WHEN 'ALV_GRID_0200'.
        PERFORM ALV_GRID_FCAT_0200 CHANGING CT_FCAT.
      WHEN OTHERS.
    ENDCASE.
