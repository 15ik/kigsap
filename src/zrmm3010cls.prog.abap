    ...
    CASE ME->M_NAME.
      WHEN 'ALV_GRID'.
        CASE E_UCOMM.
          ...
          WHEN 'BTN_HIST'.   "단가 이력 조회
            PERFORM POPUP_COND_HISTORY.
...
*-- 네이밍룰 EVT_M_NAME으로 구별가능한 것으로
      ...
      WHEN 'ALV_HIST'.
        PERFORM EVT_HIST_DOUBLE_CLICK USING E_ROW-INDEX
                                            E_COLUMN.

      WHEN 'ALV_BOM'.
        PERFORM EVT_BOM_DOUBLE_CLICK USING E_ROW-INDEX
                                           E_COLUMN.
      WHEN OTHERS.
    ENDCASE.
...
*--------------------------
      ...
      WHEN 'ALV_HIST'.
        PERFORM ALV_HIST_FCAT_MODIFY CHANGING CT_FCAT.

      WHEN 'ALV_BOM'.
        PERFORM ALV_BOM_FCAT_MODIFY CHANGING CT_FCAT.
...
*===============================================================================================
  METHOD ON_SET_LAYOUT.
    ...
    CASE IV_NAME.
      ...
      WHEN 'ALV_HIST' OR 'ALV_BOM' OR 'ALV_MRO'.
        CS_LAYOUT-ZEBRA      = 'X'.
