...
SELECTION-SCREEN BEGIN OF BLOCK BLK1 WITH FRAME TITLE TEXT-B01.
  PARAMETERS: P_BUKRS LIKE ZTMM40920-BUKRS,                        "회사코드
              P_WERKS LIKE ZTMM40920-WERKS MODIF ID PWE,           "플랜트
*              P_LGORT LIKE ZTMM40920-LGORT MODIF ID PLG,           "저장위치
*              P_LIFNR LIKE ZTMM40930-LIFNR MODIF ID PLI,           "공급업체
*              P_KUNNR LIKE ZTMM40950-KUNNR MODIF ID PKU,           "고객
              P_BUDAT LIKE ZTMM40950-BUDAT MODIF ID PBU,           "전기일
              P_FILE  TYPE RLGRAP-FILENAME MODIF ID PFI.           "파일경로
  SELECT-OPTIONS: S_MATNR FOR ZTMM40920-MATNR MODIF ID SMA,        "자재코드
                  S_CHARG FOR ZTMM40920-CHARG MODIF ID SCH,        "배치번호
                  S_WERKS FOR ZTMM40920-WERKS MODIF ID SWE,        "플랜트
                  S_LGORT FOR ZTMM40920-LGORT MODIF ID SLG,        "저장위치
                  S_LIFNR FOR ZTMM40930-LIFNR MODIF ID SLI,        "공급업체
                  S_KUNNR FOR ZTMM40950-KUNNR MODIF ID SKU,        "고객
                  S_ERDAT FOR ZTMM40920-ERDAT MODIF ID SER,        "생성일
                  S_ERNAM FOR ZTMM40920-ERNAM MODIF ID SER.        "작업자
...
**  SELECTION-SCREEN BEGIN OF LINE.
**    PARAMETERS: P_RD1A RADIOBUTTON GROUP RD1 DEFAULT 'X' USER-COMMAND RA.
**    SELECTION-SCREEN COMMENT 4(15) TEXT-T01 FOR FIELD P_RD1A.  "배치 Migration
**    SELECTION-SCREEN POSITION 20.
**
**    PARAMETERS: P_RD1B RADIOBUTTON GROUP RD1.
**    SELECTION-SCREEN COMMENT 21(16) TEXT-T02 FOR FIELD P_RD1B. "창고 재고 Migration
**    SELECTION-SCREEN POSITION 40.
**
**    PARAMETERS: P_RD1C RADIOBUTTON GROUP RD1.
**    SELECTION-SCREEN COMMENT 41(16) TEXT-T03 FOR FIELD P_RD1C. "사급 재고 Migration
**    SELECTION-SCREEN POSITION 59.
**
**    PARAMETERS: P_RD1D RADIOBUTTON GROUP RD1.
**    SELECTION-SCREEN COMMENT 61(16) TEXT-T04 FOR FIELD P_RD1D. "위탁 재고 Migration
**    SELECTION-SCREEN POSITION 78.
**
**    PARAMETERS: P_RD1E RADIOBUTTON GROUP RD1.
**    SELECTION-SCREEN COMMENT 79(16) TEXT-T05 FOR FIELD P_RD1E. "고객 재고 Migration
**  SELECTION-SCREEN END OF LINE.
**SELECTION-SCREEN END OF BLOCK BLK2.
*- U3 END
