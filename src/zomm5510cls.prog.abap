...
*===================================================================================================
  METHOD EVT_DOUBLE_CLICK.
    ...
    CASE ME->M_NAME.
      WHEN 'ALV_GRID_01'.
*-- 네이밍룰 EVT_M_NAME으로 구별가능한 것으로
        PERFORM EVT_GRID_01_DOUBLE_CLICK USING E_ROW-INDEX
                                               E_COLUMN.

      WHEN 'ALV_GRID_02'.
        PERFORM EVT_GRID_02_DOUBLE_CLICK USING E_ROW-INDEX
                                               E_COLUMN.
...
*--------------------------
        PERFORM ALV_GRID_01_FCAT_MODIFY CHANGING CT_FCAT.

      WHEN 'ALV_GRID_02'.
        PERFORM ALV_GRID_02_FCAT_MODIFY CHANGING CT_FCAT.
...
*===============================================================================================
  METHOD ON_SET_LAYOUT.
    ...
    CASE IV_NAME.
      WHEN 'ALV_GRID_01' OR 'ALV_GRID_02'.
        CS_LAYOUT-ZEBRA      = 'X'.
