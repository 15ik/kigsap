...
*------------------------------------------------------------
        CASE E_UCOMM.
          WHEN 'OK_CODE'.
          WHEN 'MAPPING_CANCEL'.  "맵핑 취소
            PERFORM BTN_MAPPING_CANCEL.
          WHEN 'MAPPING_EXCUTE'.  "맵핑 실행
            PERFORM BTN_MAPPING_EXCUTE.
          WHEN 'POSTING_CANCEL'.  "송장 취소
            PERFORM BTN_POSTING_CANCEL.
          WHEN 'DETAIL_POPUP'.  "거래명세서
            PERFORM BTN_DETAIL_POPUP.
          WHEN 'REISSUE_SEND'. "역발행 전송
            PERFORM BTN_REISSUE_SEND.
          WHEN 'REISSUE_CANCEL'. "역발행 회수
            PERFORM BTN_REISSUE_CANCEL.
          WHEN 'APPROVAL_LINK'. "전자결재 LINK
            PERFORM BTN_APPROVAL_LINK.
          WHEN OTHERS.
