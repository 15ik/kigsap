...
*--------------------------------------
    TYPES: BEGIN OF LTY_F4_WERKS,          "Perform 안에서도 동일하게 선언
             WERKS TYPE T001W-WERKS,
             NAME1 TYPE T001W-NAME1,
           END OF LTY_F4_WERKS.

    TYPES: BEGIN OF LTY_F4_LGORT,
             LGORT TYPE T001L-LGORT,
             LGOBE TYPE T001L-LGOBE,
           END OF LTY_F4_LGORT.

    TYPES: BEGIN OF LTY_F4_EKGRP,
...
*--------------------------------------
    CASE IV_FIELDNAME.
      WHEN 'WERKS'.
        CREATE DATA AO_F4 TYPE TABLE OF LTY_F4_WERKS.
        ASSIGN AO_F4->* TO <LT_F4_LIST>.

      WHEN 'LGORT'.
        CREATE DATA AO_F4 TYPE TABLE OF LTY_F4_LGORT.
        ASSIGN AO_F4->* TO <LT_F4_LIST>.

      WHEN 'EKGRP'.
        CREATE DATA AO_F4 TYPE TABLE OF LTY_F4_EKGRP.
        ASSIGN AO_F4->* TO <LT_F4_LIST>.
    ENDCASE.
