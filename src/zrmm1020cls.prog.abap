...
*=======================================================================
  METHOD EVT_ON_DATA_CHANGED.
    ...
    CASE ME->M_NAME.
      WHEN 'ALV_GRID_0200'.
        PERFORM EVT_GRID_0200_DATA_CHANGED USING IRF_DATA_CHANGED
                                                 IV_ONF4
                                                 IV_ONF4_BEFORE
                                                 IV_ONF4_AFTER
                                                 IV_UCOMM.
...
*--------------------------------------
    TYPES:BEGIN OF LTY_VERID_F4,
          ...
          END OF LTY_VERID_F4.
**
    FIELD-SYMBOLS:<LT_F4_VERID_LIST> TYPE TABLE.
...
*--------------------------------------
    CASE IV_FIELDNAME.
      WHEN 'VERID'.
        CREATE DATA AO_F4 TYPE TABLE OF LTY_VERID_F4.
        ASSIGN AO_F4->* TO <LT_F4_VERID_LIST>.
    ENDCASE.
...
*--------------------------------------
    CASE ME->M_NAME.
      WHEN 'ALV_GRID_0200'.
        CASE IV_FIELDNAME.
          WHEN 'VERID'.
            PERFORM EVT_GRID_F4 USING    IV_FIELDNAME IS_ROW_NO
                                CHANGING <LT_F4_VERID_LIST>
                                         CV_TITLE
                                         EV_MONTH_DISPLAY .
...
*===============================================================================================
  METHOD ON_EXCLUD_STD_TOOLBAR.
    ...
    CASE IV_NAME.
      WHEN 'ALV_GRID'.
      WHEN 'ALV_GRID_0200'.
        CT_EX_TOOLBAR = VALUE #( ( CL_GUI_ALV_GRID=>MC_FC_CURRENT_VARIANT )
...
*-- 네이밍룰 EVT_M_NAME으로 구별가능한 것으로
        PERFORM EVT_GRID_HOTSPOT_CLICK USING ES_ROW_NO-ROW_ID
                                             E_COLUMN_ID.
      WHEN 'ALV_GRID_0200'.
        PERFORM EVT_GRID_0200_HOTSPOT_CLICK USING ES_ROW_NO-ROW_ID
                                                  E_COLUMN_ID.
      WHEN OTHERS.
    ENDCASE.
...
*===============================================================================================
  METHOD ON_SET_LINE_STYLE.
    ...
    CASE IV_NAME.
      ...
      WHEN 'ALV_GRID_0200'.
        PERFORM ALV_GRID_0200_SET_LINE_STYLE USING IT_FCAT.
    ENDCASE.
...
*===============================================================================================
  METHOD ON_SET_F4.
    ...
    CASE IV_NAME.
      WHEN 'ALV_GRID_0200'.
        PERFORM ALV_SET_F4_0200 CHANGING CT_FIELD.
    ENDCASE.
