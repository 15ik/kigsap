    ...
    CASE ME->M_NAME.
      WHEN 'ALV_GRID'.
        CASE E_UCOMM.
          ...
          WHEN 'BTN_DRAFT'.
            PERFORM BTN_APPR_DRAFT.     "결재상신

          WHEN 'BTN_WITHDRAW'.
            PERFORM BTN_APPR_WITHDRAW.  "결재회수

          WHEN 'BTN_CANCEL'.
            PERFORM BTN_CANCEL.  "구매요청삭제

          WHEN 'BTN_SUBMIT' OR 'BTN_ALLOW' OR 'BTN_REJECT'. "Function Test
            PERFORM BTN_TEST USING E_UCOMM.
